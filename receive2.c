...
printf("hii");
	...
	FILE* output = fopen("output.txt" , "a");; //output file pointer
    //set value of pointer to point to output.txt; will be appending to the file
